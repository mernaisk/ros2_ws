...
class MotorCommandPublisher(Node):
    def __init__(self):
        ...
        self.timer = self.create_timer(0.01, self.update_motor_command)
    ...
    def update_motor_command(self):
        ...
        self.z_l_fl = func3_value
        self.z_l_rr = func3_value
        self.z_l_fr = func4_value
        self.z_l_rl = func4_value
