...
static const _DebugParameter_type_support_symbol_names_t _DebugParameter_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_parameters, msg, DebugParameter)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_parameters, msg, DebugParameter)),
  }
};
...
{
  return &::my_parameters::msg::rosidl_typesupport_cpp::DebugParameter_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_parameters, msg, DebugParameter)() {
  return get_message_type_support_handle<my_parameters::msg::DebugParameter>();
}
