...
static const _ObstacleProximityLog_type_support_symbol_names_t _ObstacleProximityLog_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_parameters, msg, ObstacleProximityLog)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_parameters, msg, ObstacleProximityLog)),
  }
};
...
{
  return &::my_parameters::msg::rosidl_typesupport_cpp::ObstacleProximityLog_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_parameters, msg, ObstacleProximityLog)() {
  return get_message_type_support_handle<my_parameters::msg::ObstacleProximityLog>();
}
